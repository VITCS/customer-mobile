...
const SvgComponent = ({ title, titleId, ...props }: SvgProps & SVGRProps) => (
  <Svg
    ...
    style={{
      enableBackground: "new 0 0 227.656 227.656",
    }}
    xmlSpace="preserve"
    width={24}
    height={24}
